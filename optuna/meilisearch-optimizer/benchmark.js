...
const SIMPLE_QUERIES = [
    ...
    'tv', 'gaming', 'watch', 'speaker', 'charger',
    'apple', 'samsung', 'sony', 'dell', 'hp',
    'wireless', 'portable', 'smart', 'pro', 'ultra'
];

const TYPO_QUERIES = [
    'laptp', 'phne', 'tblet', 'hedphones', 'camra',
    'samsng', 'wirless', 'portble', 'smat', 'gamng'
];

const PHRASE_QUERIES = [
    'gaming laptop', 'wireless headphones', 'smart tv',
    'portable speaker', 'digital camera', 'fitness watch',
    'pro tablet', 'ultra phone', 'compact charger'
];
